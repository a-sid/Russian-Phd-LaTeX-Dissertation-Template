...
\begin{tikzpicture}[ampersand replacement=\&,thick,anchor=base,
                    ...
                    text depth=.25ex,
                      align=center]
\tikzstyle{format} = [anchor=base,thick,
                      minimum size=1cm,
                      draw=black,
                      top color=white]
...
(Картинка из презентации)
  \center{\includegraphics[width=1\linewidth]{../Dissertation/images/xtu-idef0-3.pdf}}
\end{figure}
\end{frame}
